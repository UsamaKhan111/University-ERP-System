      ...
      {isAdmin ? (
        <form className="rounded border border-stone-200 bg-white p-4 shadow-panel" onSubmit={createFee}>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-5">
            ...
            <input className="rounded border border-stone-300 px-3 py-2 text-sm" min="0" name="amount" type="number" value={form.amount} onChange={handleChange} placeholder="Amount" required />
